...
export const THEMES: readonly Theme[] = [
  ...
  {
    // Dark glass with light behind it; the jewel colours live in the border of
    // panes, so the body stays dark enough to read on.
    id: 'stainedglass',
    label: 'Stained glass',
    note: 'leaded panes, jewel light, a ruby to close',
    fill: 0x1c1a2c, fillDeep: 0x131220, edge: 0x6a6096,
    text: 0xf0e9d8, dim: 0xb3abc8,
    accent: 0xe0b84a, highlight: 0x86d3ff,
    row: 0x28243f, rowHot: 0x352f55, rowSel: 0x463d72,
    danger: 0xe0503f, good: 0x6cc07a,
    ink: 0x1c1a2c, titleInk: 0xf2c95a,
    radius: 2, bevel: false, gloss: false, titleBar: false, bodyAlpha: 0.97,
    pinstripe: false, scanlines: false, border: 1,
  ...
  },
  {
    id: 'brass',
    label: 'Brass & rivets',
    note: 'walnut, riveted brass, an engraved plate',
    fill: 0x2a1d14, fillDeep: 0x1e140d, edge: 0x8f6a3a,
    text: 0xecd9b4, dim: 0xa88e68,
    accent: 0xd6a24a, highlight: 0xf2c86e,
    row: 0x36261a, rowHot: 0x46321f, rowSel: 0x584028,
    danger: 0xc2553a, good: 0x8fa34a,
    ink: 0x21160e, titleInk: 0xe8b85a,
    radius: 5, bevel: false, gloss: false, titleBar: false, bodyAlpha: 0.98,
    pinstripe: false, scanlines: false, border: 1,
    // Bahnschrift is DIN — the lettering of gauges and nameplates — and ships
    // with Windows 10 and later.
    font: 'Bahnschrift, "Segoe UI", sans-serif',
    frame: 'brass',
  },
  {
    // Their own: mossy stone, and the green of a Mudgin's eye for everything
    // that is lit.
    id: 'shrine',
    label: 'Bog shrine',
    note: 'mossy stone, drips, and the eye',
    fill: 0x2b312a, fillDeep: 0x1f241e, edge: 0x4d5846,
    text: 0xd6dcc4, dim: 0x8e9a80,
    accent: 0xb8cc50, highlight: 0xe0f07a,
    row: 0x353d33, rowHot: 0x414b3e, rowSel: 0x4e5a49,
    danger: 0xc0684a, good: 0xb8cc50,
    ink: 0x1a1f18, titleInk: 0xc9dc6a,
    radius: 10, bevel: false, gloss: false, titleBar: false, bodyAlpha: 0.98,
    pinstripe: false, scanlines: false, border: 1,
    font: 'Constantia, Georgia, serif',
    frame: 'shrine',
  },
  {
    id: 'holo',
    label: 'Holographic',
    note: 'turning foil, split light, drifting sheen',
    fill: 0x14131f, fillDeep: 0x0d0c16, edge: 0x3a3558,
    text: 0xeae6ff, dim: 0x9c95c4,
    accent: 0x8fe3ff, highlight: 0xff9ef0,
    row: 0x1d1b2e, rowHot: 0x292642, rowSel: 0x353158,
    danger: 0xff6b8a, good: 0x7affc8,
    ink: 0x14131f, titleInk: 0xbfe9ff,
    radius: 12, bevel: false, gloss: false, titleBar: false, bodyAlpha: 0.92,
    pinstripe: false, scanlines: false, border: 1,
    font: '"Segoe UI Variable Display", "Segoe UI", sans-serif',
    frame: 'holo',
  },
  {
    // Rice paper and one ink: everything that is not black is the seal's red.
    id: 'inkwash',
    label: 'Ink wash',
    note: '水墨 — brush, rice paper, a red seal',
    fill: 0xf1ece0, fillDeep: 0xf8f5ec, edge: 0x9a9282,
    text: 0x1d1b18, dim: 0x6b665c,
    accent: 0x2d2a26, highlight: 0xb3261e,
    row: 0xe7e0d0, rowHot: 0xddd4c0, rowSel: 0xcfc4ab,
    danger: 0xb3261e, good: 0x4b6b3a,
    ink: 0xf8f5ec, titleInk: 0x1d1b18,
    radius: 2, bevel: false, gloss: false, titleBar: false, bodyAlpha: 1,
    pinstripe: false, scanlines: false, border: 1,
