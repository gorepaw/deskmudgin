...
//
//   npm run build:web && npm run snap -- themes shots/themes.png [width height] [page]
//
// Sheets: themes, speech, growth, 1 (the population sheet). See
...
if (!sheet || !out) {
  console.error('usage: node tools/snap.mjs <sheet> <out.png> [width height] [page]')
  process.exit(2)
}
